...
export const CookieBanner = () => {
  ...
  return (
    <>
      <div className="fixed inset-0 bg-black/50 backdrop-blur-xs z-20" />

      <div className="mx-2 md:mx-auto px-3 py-5 max-w-4xl fixed top-10 left-0 right-0 bg-white z-20 md:bottom-5 md:top-auto text-sm rounded-xl border border-gray-200 flex gap-4 shadow-[1px_1px_8px_rgba(0,0,0,0.20)]">
        <Image
